...
- Add component coverage for custom-domain confirmation, cancellation, sequential connect/verify calls, DNS retry cooldown, and active-domain guidance when a UI test harness is introduced.
