...
- Add component coverage for the direct-message composer's 1,000-byte UTF-8 limit across drafts, typing, emoji insertion, outgoing text, and Unicode-safe truncation when a UI test harness is introduced.
