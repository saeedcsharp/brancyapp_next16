# legacy-pages/Accessibility

## Purpose

Legacy page module for Accessibility routes and workflows.

## Business Purpose

Preserves existing Brancy Accessibility feature behavior during App Router migration.
