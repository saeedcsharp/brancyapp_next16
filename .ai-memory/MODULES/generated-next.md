...
Generated Next.js build/dev output.
...
AI Reading Priority: 4

Source Of Truth: Next build tooling only; do not treat generated output as source code.

Depends On: build pipeline, Next compilation, PWA generation

Used By: Local development and build artifacts

Change Impact: Regeneration behavior only; manual edits should not be used as source of truth

## Business Purpose

Supports local development/build artifacts only.
