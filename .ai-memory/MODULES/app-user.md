...
Route group for user/customer dashboard pages.

## Business Purpose

Supports buyer/customer workflows, business/shop browsing, orders, wallet, settings, and payments.
...
`app/(user)/` route wrappers and layout.
