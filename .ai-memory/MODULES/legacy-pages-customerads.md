# legacy-pages/customerads

## Purpose

Legacy page module for customerads routes and workflows.

## Business Purpose

Preserves existing Brancy customerads feature behavior during App Router migration.
