# legacy-pages/customershop

## Purpose

Legacy page module for customershop routes and workflows.

## Business Purpose

Preserves existing Brancy customershop feature behavior during App Router migration.
