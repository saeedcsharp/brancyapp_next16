...
Custom block-based rich text editor under design components.

## Business Purpose

Provides product/content description editing without Quill dependency.
...
`components/design/textEditor/` documented from repository memory; update this module whenever editor files change.
...
Parent module: `components/design`.
