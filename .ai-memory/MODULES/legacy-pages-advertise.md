# legacy-pages/advertise

## Purpose

Legacy page module for advertise routes and workflows.

## Business Purpose

Preserves existing Brancy advertise feature behavior during App Router migration.
