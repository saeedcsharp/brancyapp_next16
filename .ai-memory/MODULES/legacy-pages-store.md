...
Legacy page module for store routes and workflows.

## Business Purpose

Preserves existing Brancy store feature behavior during App Router migration.
