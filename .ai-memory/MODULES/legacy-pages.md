...
Legacy Next pages implementation tree.
...
Source Of Truth: `legacy-pages/`

Depends On: `components/`, `helper/`, `context/`

Used By: App Router wrappers and feature screens

Change Impact: Mature feature flows, App Router bridge behavior, migration compatibility

## Business Purpose

Contains most mature feature page implementations now rendered by App Router wrappers.
