...
Compatibility layer for legacy `next/router` and intercepted route modals.

## Business Purpose

Allows legacy pages to run inside App Router without full rewrite.
...
`app/_compat/next-router.ts`, `app/_compat/InterceptedRouteModal.tsx`.
