...
Defines package metadata, framework configuration, deployment files, documentation, and top-level source folders.

## Business Purpose

Hosts the Brancy frontend application.
...
`package.json`, `next.config.js`, `tsconfig.json`, `Dockerfile`, `web.config`, top-level source folders.
