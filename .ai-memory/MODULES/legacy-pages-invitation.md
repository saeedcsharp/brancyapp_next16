# legacy-pages/invitation

## Purpose

Legacy page module for invitation routes and workflows.

## Business Purpose

Preserves existing Brancy invitation feature behavior during App Router migration.
