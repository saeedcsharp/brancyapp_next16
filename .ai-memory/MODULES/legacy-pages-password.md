# legacy-pages/password

## Purpose

Legacy page module for password routes and workflows.

## Business Purpose

Preserves existing Brancy password feature behavior during App Router migration.
