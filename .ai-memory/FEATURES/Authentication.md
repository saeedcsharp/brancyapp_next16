...
The Meta direct-login flow waits 15 seconds after successful verification before navigating to `/directlogin`, preserving the existing loading presentation during the delay.
