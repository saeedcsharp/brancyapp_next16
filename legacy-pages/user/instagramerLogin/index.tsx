...
import FaceBook from "saeed/components/signIn/faceBook";
  ...
  return (
    <div className="dialogBg">
      <div className={styles.colorring}>
        <img className={styles.colorring1} src="/ring.svg"></img>
        <img className={styles.colorring2} src="/ring.svg"></img>
        <img className={styles.colorring3} src="/ring.svg"></img>
        <img className={styles.colorring4} src="/ring.svg"></img>
      </div>
            ...
            <>
              <div className="headerandinput" style={{ alignItems: "center" }}>
                ...
                <p
                  ...
                  {t(LanguageKey.welcomeToBrancyExplain)}
                </p>
                {instagramers.length > 0 && (
                  <div className="headerandinput" style={{ marginTop: "30px" }}>
          ...
          <div
            ...
            <div className="headerparent">
              <div className={styles.stepIndicator}>
                <span className={currentStep === 1 ? styles.activeStep : styles.inactiveStep}>1</span>
                <span className={currentStep === 2 ? styles.activeStep : styles.inactiveStep}>2</span>
                <span className={currentStep === 3 ? styles.activeStep : styles.inactiveStep}>3</span>
                <span className={currentStep === 4 ? styles.activeStep : styles.inactiveStep}>4</span>
              </div>
      ...
      {showVerificationCode && (
        <FaceBook
          preInstaToken={preInstaToken}
          backToInstaId={handleBackInstaId}
