...
const FAQ = () => {
  ...
  const categories: Category[] = [
    { id: "all", name: t("allCategories") || "All Categories", icon: "📂" },
    { id: "financial", name: t("financial") || "Financial", icon: "💰" },
    { id: "account", name: t("account") || "Account & Profile", icon: "👤" },
    { id: "payments", name: t("payments") || "Payments & Billing", icon: "💳" },
    { id: "security", name: t("security") || "Security & Privacy", icon: "🔒" },
    { id: "features", name: t("features") || "Features & Usage", icon: "⚙️" },
    { id: "technical", name: t("technical") || "Technical Issues", icon: "🔧" },
  ];
  ...
  const faqItems: FAQItem[] = [
    {
      id: "financial-1",
      category: "financial",
      question: t("faq_q1") || "What is the difference between needs and wants in the context of shopping?",
      answer:
        t("faq_a1") ||
    ...
    },
    {
      id: "financial-2",
      category: "financial",
      question: t("faq_q2") || "What is the significance of understanding consumer behavior in shopping?",
      answer:
        t("faq_a2") ||
    ...
    },
    {
      id: "financial-3",
      category: "financial",
      question: t("faq_q3") || "How do personal factors play a role in shaping shopping behavior?",
      answer:
        t("faq_a3") ||
    ...
    },
    {
      id: "financial-4",
      category: "financial",
      question: t("faq_q4") || "How do consumers assess and compare different options during the shopping process?",
      answer:
        t("faq_a4") ||
    ...
    },
    {
      id: "financial-5",
      category: "financial",
      question: t("faq_q5") || "What is the post-purchase evaluation and how does it influence future buying behavior?",
      answer:
        t("faq_a5") ||
    ...
    },
    {
      id: "account-1",
      category: "account",
      question: t("faq_account_q1") || "How do I create a new account?",
      answer:
        t("faq_account_a1") ||
    ...
    },
    {
      id: "account-2",
      category: "account",
      question: t("faq_account_q2") || "How can I reset my password?",
      answer:
        t("faq_account_a2") ||
    ...
    },
    {
      id: "payments-1",
      category: "payments",
      question: t("faq_payments_q1") || "What payment methods do you accept?",
      answer:
        t("faq_payments_a1") ||
    ...
    },
    {
      id: "security-1",
      category: "security",
      question: t("faq_security_q1") || "How secure is my data?",
      answer:
        t("faq_security_a1") ||
    ...
    },
    {
      id: "features-1",
      category: "features",
      question: t("faq_features_q1") || "How do I invite team members?",
      answer:
        t("faq_features_a1") ||
    ...
    },
    {
      id: "technical-1",
      category: "technical",
      question: t("faq_technical_q1") || "The app is running slowly. What should I do?",
      answer:
        t("faq_technical_a1") ||
    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.hero}>
          <h1 className={styles.title}>{t("footer_FAQ") || "FAQ"}</h1>
          <p className={styles.subtitle}>{t("page8_FAQExplain") || "All Questions"}</p>
        </div>
        ...
        <div className={styles.searchSection}>
          <div className={styles.searchBox}>
            ...
            <input
              type="text"
              placeholder={t("searchFAQ") || "write a question or problem"}
              value={searchTerm}
        ...
        <div className={styles.controls}>
          <div className={styles.controlsLeft}>
            <span className={styles.resultsCount}>
              {filteredFAQs.length} {t("questionsFound") || "questions found"}
            </span>
          </div>
        ...
        <div className={styles.faqSection}>
          {filteredFAQs.length === 0 ? (
            <div className={styles.noResults}>
              ...
              <h3>{t("noQuestionsFound") || "No questions found"}</h3>
        ...
        <div className={styles.contactSection}>
          ...
          <p className={styles.contactDescription}>
            {t("supportTeamHelp") || "Our support team is here to help you with any questions not covered in our FAQ."}
          </p>
          <div className={styles.contactButtons}>
            <button className={styles.contactButton}>
              <span className={styles.buttonIcon}>💬</span>
              {t("startLiveChat") || "Start Live Chat"}
            </button>
            <button className={styles.contactButton}>
              <span className={styles.buttonIcon}>📧</span>
        ...
        <div className={styles.popularSection}>
          <h2 className={styles.popularTitle}>{t("popularHelpTopics") || "Popular Help Topics"}</h2>
          <div className={styles.topicsGrid}>
            <div className={styles.topicCard}>
              <div className={styles.topicIcon}>🚀</div>
              <h3>{t("gettingStarted") || "Getting Started"}</h3>
              <p>{t("gettingStartedDesc") || "Learn the basics of using Brancy"}</p>
              <button className={styles.topicButton}>{t("viewGuide") || "View Guide"}</button>
            </div>
            <div className={styles.topicCard}>
              <div className={styles.topicIcon}>👥</div>
              <h3>{t("teamManagement") || "Team Management"}</h3>
              <p>{t("teamManagementDesc") || "Invite and manage team members"}</p>
              <button className={styles.topicButton}>{t("viewGuide") || "View Guide"}</button>
            </div>
            <div className={styles.topicCard}>
              <div className={styles.topicIcon}>🔧</div>
              <h3>{t("integrations") || "Integrations"}</h3>
              <p>{t("integrationsDesc") || "Connect your favorite tools"}</p>
              <button className={styles.topicButton}>{t("viewGuide") || "View Guide"}</button>
            </div>
            <div className={styles.topicCard}>
              <div className={styles.topicIcon}>📊</div>
              <h3>{t("analytics") || "Analytics"}</h3>
              <p>{t("analyticsDesc") || "Understanding your data"}</p>
              <button className={styles.topicButton}>{t("viewGuide") || "View Guide"}</button>
            </div>
          </div>
        </div>
