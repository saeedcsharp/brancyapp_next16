...
import PickingUp from "brancy/components/store/order/3-PickingUp";
import Sent from "brancy/components/store/order/4-Sent";
import Delivered from "brancy/components/store/order/5-Delivered";
import Failed from "brancy/components/store/order/6-Failed";
import OrderDelivered from "brancy/components/store/order/popup/OrderDelieverd";
import OrderDetail from "brancy/components/store/order/popup/OrderDetail";
