...
import Queue from "saeed/components/store/order/1-Queue";
import InProgress from "saeed/components/store/order/2-InProgress";
import PickingUp from "saeed/components/store/order/3-PickingUp";
import Sent from "saeed/components/store/order/4-Sent";
import Delivered from "saeed/components/store/order/5-Delivered";
import Failed from "saeed/components/store/order/6-Failed";
import OrderDelivered from "saeed/components/store/order/popup/OrderDelieverd";
import OrderDetail from "saeed/components/store/order/popup/OrderDetail";
import OrderFailed from "saeed/components/store/order/popup/OrderFailed";
import OrderPickup from "saeed/components/store/order/popup/OrderPickup";
import OrderSend from "saeed/components/store/order/popup/OrderSend";
