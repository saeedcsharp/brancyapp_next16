...
export default function InProgress({
  ...
  handleReadyForShipping: (orderId: Set<string>) => void;
  ...
  const handleScroll = () => {
    ...
    if (container && container.scrollHeight - container.scrollTop === container.clientHeight) {
      handleFetchMoreItem(orders.nextMaxId, OrderStepStatus.Inprogress);
    }
  };
  useEffect(() => {
                    ...
                    <div className={styles.action}>
                      <img
                        onClick={() => {
                          ...
                          handleReadyForShipping(state.selectedOrders);
                        }}
                        style={{
                          width: "30px",
                          height: "30px",
