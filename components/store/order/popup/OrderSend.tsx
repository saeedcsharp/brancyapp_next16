...
import { IFullProduct, IOrderDetail, IParcelInfo } from "../../../../models/store/orders";
...
interface OrderDetailProps {
  ...
  handleSendOrderByNonTrackingIdOrderDeliverd: (orderId: string) => void;
}

const OrderSend: FC<OrderDetailProps> = ({ removeMask, orderDetail, handleSendOrderByNonTrackingIdOrderDeliverd }) => {
            ...
            <div className="headerandinput">
              <div className="headerparent">
                ...
                <div className={styles.orderStep}>
                  <div className={styles.StepSend_orderprogressStep} title="Order in progress">
                    <svg
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 28 28"
                  ...
                  <div className={styles.StepSend_orderpickupStep} title="Order pickup">
                    <svg
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 26 26"
                  ...
                  <div
                    ...
                    className={
                      !activeFullProduct
                        ? `${styles.StepSend_ordersendStep} ${styles.StepSend_orderprogressStepactive}`
                        : styles.StepSend_ordersendStep
                    }
              ...
              <div className={styles.headerStyle}>
                <div className="title">
                  {activeFullProduct ? t(LanguageKey.Storeorder_orderDetailsStep) : t(LanguageKey.Storeproduct_sent)}
                </div>

                <div className={styles.ordernumber}>{fullProduct?.order.id}</div>
              </div>
            </div>
            {activeTab === "content" && activeFullProduct && !loadingFullProduct && fullProduct && (
              <OrderDetailContent ordersProductInfo={fullProduct} />
            )}
            {activeTab === "maincontent" && !activeFullProduct && orderDetail.trackingId !== null && parcelInfo && (
              <div className={styles.maincontent}>
                ...
                <div className={styles.attention}>
                  ...
                  {t(LanguageKey.Storeorder_SendExplain)}
                </div>
              </div>
            )}
            {activeTab === "maincontent" && !activeFullProduct && orderDetail.trackingId === null && (
              <>
                <div className={styles.maincontent}>
                  <div className={styles.attention}>
                    <svg
                ...
                <div className="ButtonContainer">
                  <div
                    onClick={() => {
                      handleSendOrderByNonTrackingIdOrderDeliverd(orderDetail.orderId);
                      removeMask();
                    }}
