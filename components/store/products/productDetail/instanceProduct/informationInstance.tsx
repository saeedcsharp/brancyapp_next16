...
import CustomTable from "../notInstanceProduct/customtable";
import styles from "./information.module.css";

const ReactQuill = dynamic(() => import("react-quill-ver2"), { ssr: false });

export default function InformationInstance({
  info,
  upadteCteateFromInformation,
  toggleNext,
}: {
  info: IProduct_Information;
        ...
        <div className="headerandinput" style={{ maxWidth: "40%", minWidth: "200px" }}>
          <div className="headerparent">
            ...
            <div className="counter" role="status" aria-label="description character count">
              <div className={styles.icon}>T</div>(<strong>{info.caption.length}</strong> /<strong>2200</strong>)
            </div>
          </div>
          <TextArea
            className={"message"}
