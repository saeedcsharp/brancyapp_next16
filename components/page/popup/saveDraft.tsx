  ...
  return (
    <>
      ...
      <div className="headerandinput" style={{ alignItems: "center" }}>
        ...
        <div className="explain">{t(LanguageKey.draftexplain)}</div>
      </div>
      <div className="ButtonContainer">
        <button onClick={props.cancelDraft} className="stopButton">
          {t(LanguageKey.delete)}
        </button>
        <button onClick={saveAsDraft} className="saveButton">
          {t(LanguageKey.save)}
        </button>
      </div>
    </>
