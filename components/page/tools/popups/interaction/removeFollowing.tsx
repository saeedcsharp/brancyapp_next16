  ...
  return (
    <>
      ...
      <div className={`popup translate`}>
        ...
        <div className="explain">{t(LanguageKey.pageLottery_deleteexplain)}</div>
        <div className="ButtonContainer">
          <button onClick={props.handleBackToUnfollowFollowing} className="cancelButton">
            {t(LanguageKey.cancel)}
          </button>
          <button onClick={removeFollowing} className={"stopButton"}>
