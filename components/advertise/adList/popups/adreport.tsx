...
import ConfirmationStatus from "saeed/components/confirmationStatus/confirmationStatus";
...
import { IAdContent, IAdReport } from "saeed/models/advertise/adList";
import { MediaType } from "saeed/models/ApiModels/Instagramer/Page/FirstPostPage";
