...
const AccessibilityHeader: React.FC<AccessibilityHeaderProps> = ({ themeState, dispatch, onShowCreateSignIn }) => {
  ...
  // Also update currentPath when the component renders (for client-side navigation)
  useEffect(() => {
  ...
  // Render menu items based on current page type
        ...
        <>
          <a
            ...
            className={`${styles.headermenulistmobile} ${
              currentPath === "/Accessibility/About-Us" ? styles.headermenulistmobileactive : ""
            }`}
            onClick={handleMenuItemClick}>
            {t(LanguageKey.footer_AboutUs)}
          </a>
          <a
            href="/Accessibility/Contact-Us"
            className={`${styles.headermenulistmobile} ${
              currentPath === "/Accessibility/Contact-Us" ? styles.headermenulistmobileactive : ""
            }`}
            onClick={handleMenuItemClick}>
            {t(LanguageKey.footer_ContactUs)}
          </a>
          <a
            href="/Accessibility/join-Us"
            className={`${styles.headermenulistmobile} ${
              currentPath === "/Accessibility/join-Us" ? styles.headermenulistmobileactive : ""
            }`}
            onClick={handleMenuItemClick}>
      ...
      return (
        <>
          <a
            ...
            className={`${styles.headermenulistmobile} ${
              currentPath === "/Accessibility/Help-Center" ? styles.headermenulistmobileactive : ""
            }`}
            onClick={handleMenuItemClick}>
            {t(LanguageKey.footer_HelpCenter)}
          </a>
          <a
            href="/Accessibility/Support"
            className={`${styles.headermenulistmobile} ${
              currentPath === "/Accessibility/Support" ? styles.headermenulistmobileactive : ""
            }`}
            onClick={handleMenuItemClick}>
            {t(LanguageKey.footer_Support)}
          </a>
          <a
            href="/Accessibility/FAQ"
            className={`${styles.headermenulistmobile} ${
              currentPath === "/Accessibility/FAQ" ? styles.headermenulistmobileactive : ""
            }`}
            onClick={handleMenuItemClick}>
            {t(LanguageKey.footer_FAQ)}
          </a>
          <a
            href="/Accessibility/Report-an-Issue"
            className={`${styles.headermenulistmobile} ${
              currentPath === "/Accessibility/Report-an-Issue" ? styles.headermenulistmobileactive : ""
            }`}
            onClick={handleMenuItemClick}>
            {t(LanguageKey.footer_ReportAnIssue)}
          </a>
        </>
      );
    } else if (isLegalPage) {
      return (
        <>
          <a
            ...
            className={`${styles.headermenulistmobile} ${
              currentPath === "/Accessibility/Terms-and-conditions" ? styles.headermenulistmobileactive : ""
            }`}
            onClick={handleMenuItemClick}>
            {t(LanguageKey.footer_TermsAndConditions)}
          </a>
          <a
            href="/Accessibility/privacy-policy"
            className={`${styles.headermenulistmobile} ${
              currentPath === "/Accessibility/privacy-policy" ? styles.headermenulistmobileactive : ""
            }`}
            onClick={handleMenuItemClick}>
            {t(LanguageKey.footer_PrivacyNotice)}
          </a>
          <a
            href="/Accessibility/Cookie-Notice"
            className={`${styles.headermenulistmobile} ${
              currentPath === "/Accessibility/Cookie-Notice" ? styles.headermenulistmobileactive : ""
            }`}
            onClick={handleMenuItemClick}>
            {t(LanguageKey.footer_CookieNotice)}
          </a>
        </>
      );
    } else if (isBlogPage) {
      return (
        <>
          <a
            ...
            className={`${styles.headermenulistmobile} ${
              currentPath === "/Accessibility/Product-Updates" ? styles.headermenulistmobileactive : ""
            }`}
            onClick={handleMenuItemClick}>
            {t(LanguageKey.footer_ProductUpdates)}
          </a>
          <a
            href="/Accessibility/Articles"
            className={`${styles.headermenulistmobile} ${
              currentPath === "/Accessibility/Articles" ? styles.headermenulistmobileactive : ""
            }`}
            onClick={handleMenuItemClick}>
            {t(LanguageKey.footer_Articles)}
          </a>
          <a
            href="/Accessibility/Latest-news"
            className={`${styles.headermenulistmobile} ${
              currentPath === "/Accessibility/Latest-news" ? styles.headermenulistmobileactive : ""
            }`}
            onClick={handleMenuItemClick}>
            {t(LanguageKey.footer_LatestNews)}
          </a>
          <a
            href="/Accessibility/Follow-Us"
            className={`${styles.headermenulistmobile} ${
              currentPath === "/Accessibility/Follow-Us" ? styles.headermenulistmobileactive : ""
            }`}
            onClick={handleMenuItemClick}>
            {t(LanguageKey.footer_FollowUs)}
          </a>
        </>
      );
    }
    // Default fallback - show company pages
    return (
      <>
        <a
          href="/Accessibility/About-Us"
        ...
        <>
          <a
            ...
            className={`${styles.headermenulist} ${
              currentPath === "/Accessibility/About-Us" ? styles.headermenulistactive : ""
            }`}>
            {t(LanguageKey.footer_AboutUs)}
          </a>
          <a
            href="/Accessibility/Contact-Us"
            className={`${styles.headermenulist} ${
              currentPath === "/Accessibility/Contact-Us" ? styles.headermenulistactive : ""
            }`}>
            {t(LanguageKey.footer_ContactUs)}
          </a>
          <a
            href="/Accessibility/join-Us"
            className={`${styles.headermenulist} ${
              currentPath === "/Accessibility/join-Us" ? styles.headermenulistactive : ""
            }`}>
            {t(LanguageKey.footer_JoinUs)}
          </a>
          <a
      ...
      return (
        <>
          <a
            href="/Accessibility/Help-Center"
            className={`${styles.headermenulist} ${
              currentPath === "/Accessibility/Help-Center" ? styles.headermenulistactive : ""
            }`}>
            {t(LanguageKey.footer_HelpCenter)}
          </a>
          <a
            href="/Accessibility/Support"
            className={`${styles.headermenulist} ${
              currentPath === "/Accessibility/Support" ? styles.headermenulistactive : ""
            }`}>
            {t(LanguageKey.footer_Support)}
          </a>
          <a
            href="/Accessibility/FAQ"
            className={`${styles.headermenulist} ${
              currentPath === "/Accessibility/FAQ" ? styles.headermenulistactive : ""
            }`}>
            {t(LanguageKey.footer_FAQ)}
          </a>
          <a
            href="/Accessibility/Report-an-Issue"
            className={`${styles.headermenulist} ${
              currentPath === "/Accessibility/Report-an-Issue" ? styles.headermenulistactive : ""
            }`}>
            {t(LanguageKey.footer_ReportAnIssue)}
          </a>
        </>
      ...
      return (
        <>
          <a
            href="/Accessibility/Terms-and-conditions"
            className={`${styles.headermenulist} ${
              currentPath === "/Accessibility/Terms-and-conditions" ? styles.headermenulistactive : ""
            }`}>
            {t(LanguageKey.footer_TermsAndConditions)}
          </a>
          <a
            href="/Accessibility/privacy-policy"
            className={`${styles.headermenulist} ${
              currentPath === "/Accessibility/privacy-policy" ? styles.headermenulistactive : ""
            }`}>
            {t(LanguageKey.footer_PrivacyNotice)}
          </a>
          <a
            href="/Accessibility/Cookie-Notice"
            className={`${styles.headermenulist} ${
              currentPath === "/Accessibility/Cookie-Notice" ? styles.headermenulistactive : ""
            }`}>
            {t(LanguageKey.footer_CookieNotice)}
          </a>
        </>
      ...
      return (
        <>
          <a
            href="/Accessibility/Product-Updates"
            className={`${styles.headermenulist} ${
              currentPath === "/Accessibility/Product-Updates" ? styles.headermenulistactive : ""
            }`}>
            {t(LanguageKey.footer_ProductUpdates)}
          </a>
          <a
            href="/Accessibility/Articles"
            className={`${styles.headermenulist} ${
              currentPath === "/Accessibility/Articles" ? styles.headermenulistactive : ""
            }`}>
            {t(LanguageKey.footer_Articles)}
          </a>
          <a
            href="/Accessibility/Latest-news"
            className={`${styles.headermenulist} ${
              currentPath === "/Accessibility/Latest-news" ? styles.headermenulistactive : ""
            }`}>
            {t(LanguageKey.footer_LatestNews)}
          </a>
          <a
            href="/Accessibility/Follow-Us"
            className={`${styles.headermenulist} ${
              currentPath === "/Accessibility/Follow-Us" ? styles.headermenulistactive : ""
            }`}>
            {t(LanguageKey.footer_FollowUs)}
          </a>
        </>
  ...
  return (
    <>
        ...
        <div className={styles.settingmobileparent}>
          ...
          <div className={styles.mobileMenuContainer} ref={menuRef}>
            ...
            <div className={`${styles.mobileMenu} ${isMenuOpen ? styles.mobileMenuOpen : ""}`}>
              <div className="title" style={{ height: "25px" }}>
                {t(LanguageKey.menu)}
              </div>
              <a
                className={styles.headermenulistmobile}
      ...
      <header className={styles.headerdesktop}>
        ...
        <div className={styles.headermenudesktop}>{renderDesktopMenuItems()}</div>
