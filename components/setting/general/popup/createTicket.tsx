...
import { ICreatePlatform } from "brancy/models/interfaces";
interface ICreateTicketProps {
  removeMask: () => void;
  handleCreateTicket: (ticketData: ICreatePlatform) => void;
}

const CreateTicket = React.memo(({ removeMask, handleCreateTicket }: ICreateTicketProps) => {
  ...
  const isFormInvalid = useMemo(() => {
    return !formData.subject.trim() || (!formData.item.text?.trim() && !formData.item.imageUrl?.trim());
    ...
    <>
      ...
      <form
        ...
        <div className="headerandinput">
          ...
          <DragDrop data={selectDepartment} handleOptionSelect={handleSelectDepartment} />
        </div>
        ...
        <div className="ButtonContainer">
          <button type="submit" className={isFormInvalid ? "disableButton" : "saveButton"} disabled={isFormInvalid}>
