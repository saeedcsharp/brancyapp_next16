...
function Filter(props: {
  ...
  return (
    <div className={`${styles.left} ${props.isLeftVisible ? styles.visible : ""}`}>
      ...
      <img
        onClick={props.handleUnshowFilter}
      ...
      <InputText
        ...
        value={searchPeaple}
        maxLength={undefined}
        name="search-people" // Add name attribute
      />
      ...
      <div className={styles.filter}>
        <div className={styles.filtercontent}>
          <div className={styles.filtersection} onClick={() => handleFilterSectionClick("filter1")}>
            <div className={styles.filterheader}>{t(LanguageKey.filter_sortby)}</div>
        ...
        <div className={styles.filtercontent}>
          <div
            ...
            <div className={styles.filterheader}>{t(LanguageKey.filter_category)}</div>
            <div className={styles.filterstate}>
        ...
        <div className={styles.filtercontent}>
          <div
            ...
            <div className={styles.filterheader}>{t(LanguageKey.filter_price)}</div>
            <div className={styles.filterstate}>
        ...
        <div className={styles.filtercontent}>
          <div
            ...
            <div className={styles.filterheader}>{t(LanguageKey.filter_rating)}</div>
            <div className={styles.filterstate}>
        ...
        <div className={styles.filtercontent}>
          <div
            ...
            <div className={styles.filterheader}>{t(LanguageKey.filter_followers)}</div>
            <div className={styles.filterstate}>
      ...
      <div className={styles.filterbutton} onClick={() => props.handleLeftVisible(false)}>
        <div className="saveButton">
          {t(LanguageKey.pageTools_Result)} (<strong>{props.totalCount}</strong>)
        </div>
      </div>
    </div>
  );
