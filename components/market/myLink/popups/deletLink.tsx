  ...
  return (
    <>
      ...
      <Head>
        ...
        <title>Bran.cy ▸ Delete Link</title>
      ...
      <div className="headerandinput" style={{ alignItems: "center" }}>
        ...
        <div className="explain">
          {t(LanguageKey.message_youareattemptingto)} <strong>{t(LanguageKey.delete)}</strong> {t(LanguageKey.linkURL)}
        </div>
      </div>
      <button onClick={() => props.handleDeleteLink(props.linkId)} className="stopButton">
