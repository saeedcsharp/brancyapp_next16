...
export const API_ROUTE_MAP: Record<string, string> = {
  ...
  "/api/order/user/getOrdersByStatus": "User/Order/GetOrdersByStatus",
  "/api/order/getOrdersByStatuses": "Shopper/Order/GetOrdersByStatuses",
  "/api/order/user/getOrdersByStatuses": "User/Order/GetOrdersByStatuses",
  "/api/order/getParcelInfo": "Shopper/Order/GetParcelInfo",
  "/api/order/user/getParcelInfo": "User/Order/GetParcelInfo",
  "/api/order/getShippingRequestType": "Shopper/Order/GetShippingRequestType",
  "/api/order/user/getShippingRequestType": "User/Order/GetShippingRequestType",
  "/api/order/readyOrderForShipping": "Shopper/Order/ReadyOrderForShipping",
  "/api/order/user/readyOrderForShipping": "User/Order/ReadyOrderForShipping",
  "/api/order/rejectOrder": "Shopper/Order/RejectOrder",
  "/api/order/user/rejectOrder": "User/Order/RejectOrder",
  "/api/order/sendOrderByNonRequestType": "Shopper/Order/SendOrderByNonRequestType",
  "/api/order/user/sendOrderByNonRequestType": "User/Order/SendOrderByNonRequestType",
  "/api/order/sentOrderByNonRequestType": "Shopper/Order/SentOrderByNonRequestType",
  "/api/order/user/sentOrderByNonRequestType": "User/Order/SentOrderByNonRequestType",
  "/api/order/sentOrderByParcelId": "Shopper/Order/SentOrderByParcelId",
  "/api/order/user/sentOrderByParcelId": "User/Order/SentOrderByParcelId",
  "/api/order/setNonTrackingIdOrderDelivered": "Shopper/Order/SetNonTrackingIdOrderDelivered",
  "/api/order/user/setNonTrackingIdOrderDelivered": "User/Order/SetNonTrackingIdOrderDelivered",
